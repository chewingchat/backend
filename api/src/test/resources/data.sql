...
INSERT INTO chewing.`user` (user_id, picture_url, background_picture_url, user_first_name,
                            user_last_name, birth, created_at, modified_at)
VALUES ('user-1', 'https://example.com/user1.png', 'Hello World!', 'User', 'One',
        '1990-01-01', NOW(), NOW()),
       ('user-2', 'https://example.com/user2.png', 'Living the life', 'User', 'Two',
        '1985-05-15', NOW(), NOW()),
       ('user-3', 'https://example.com/user3.png', 'Good vibes only', 'User', 'Three',
        '1992-07-20', NOW(), NOW());
