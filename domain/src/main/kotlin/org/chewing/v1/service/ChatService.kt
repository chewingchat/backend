...
import org.chewing.v1.implementation.auth.AuthAppender
import org.chewing.v1.implementation.auth.AuthProcessor
...
class ChatService(
    ...
    fun sendFileMessage(chatRoomId: String, fileDataList: List<FileData>) {
        // 파일을 처리하여 Media로 변환
        val mediaList = fileProcessor.processNewFiles(chatRoomId, fileDataList, FileCategory.FEED)
