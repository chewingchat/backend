...
class ChatMessageRepositoryImpl(
    ...
    override fun readChatMessages(roomId: String, page: Int): ChatLog {
        ...
        return ChatLog.generate(page, roomId, messageEntities.map { ChatMessageMongoEntity.toChatMessage(it) }, friends)
    }
