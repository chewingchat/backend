...
object ScheduleProvider {
    ...
    fun build1000YearFirstTime(): ScheduleTime{
        return ScheduleTime.of(LocalDateTime.of(1000,1,1,0,0,0),LocalDateTime.of(1000,12,31,23,59,59) , LocalDateTime.now())
    }
    fun build1000YearSecondTime(): ScheduleTime{
        return ScheduleTime.of(LocalDateTime.of(1000,1,2,0,0,0),LocalDateTime.of(1000,12,31,23,59,59) , LocalDateTime.now())
    }
}